...
@XmlRootElement(name = "notifyCycleData", namespace = "http://gws.amtote.com/")
public record CycleDataUpdatedNotificationMessage(@XmlElement(name = "ToteID") String toteID,

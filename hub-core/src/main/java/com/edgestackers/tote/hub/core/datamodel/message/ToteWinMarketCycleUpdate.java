...
public record ToteWinMarketCycleUpdate(@JsonProperty("feed_service_cycle_pool_update_id") String feedServiceCyclePoolUpdateId,
                                       ...
                                       @JsonProperty("prices") Map<Integer, Double> marketPrices,
